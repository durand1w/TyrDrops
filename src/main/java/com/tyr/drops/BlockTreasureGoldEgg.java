...
public class BlockTreasureGoldEgg extends Block
{
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	//EAST
	protected static final AxisAlignedBB TREASURE_CHALICE_GOLD_SOUTH_AABB = new AxisAlignedBB(0.1875F, 0.0F, 0.1875F, 0.8125F, 0.75F, 0.8125F);
	//SOUTH
	protected static final AxisAlignedBB TREASURE_CHALICE_GOLD_WEST_AABB = new AxisAlignedBB(0.1875F, 0.0F, 0.1875F, 0.8125F, 0.75F, 0.8125F);
	//WEST
	protected static final AxisAlignedBB TREASURE_CHALICE_GOLD_NORTH_AABB = new AxisAlignedBB(0.1875F, 0.0F, 0.1875F, 0.8125F, 0.75F, 0.8125F);
	//NORTH
	protected static final AxisAlignedBB TREASURE_CHALICE_GOLD_EAST_AABB = new AxisAlignedBB(0.1875F, 0.0F, 0.1875F, 0.8125F, 0.75F, 0.8125F);
	
	public BlockTreasureGoldEgg(String blockName)
	{
		super(Material.IRON);
