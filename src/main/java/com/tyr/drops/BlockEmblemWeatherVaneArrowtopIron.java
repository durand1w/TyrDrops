...
public class BlockEmblemWeatherVaneArrowtopIron extends Block 
{
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	protected static final AxisAlignedBB EMBLEM_WEATHER_VANE_ARROWTOP_IRON_NORTH_SOUTH_AABB = new AxisAlignedBB(0.4375F, 0.0F, 0.0F, 0.5625F, 0.4375F, 1.0F);
	protected static final AxisAlignedBB EMBLEM_WEATHER_VANE_ARROWTOP_IRON_EAST_WEST_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.4375F, 1.0F, 0.4375F, 0.5625F);
	
    public BlockEmblemWeatherVaneArrowtopIron(String blockName)
    {       
        super(Material.IRON);
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos)
    {
        AxisAlignedBB axisalignedbb;
            ...
            switch ((EnumFacing)state.getValue(FACING))
            {
                case NORTH:
                default:
                    axisalignedbb = EMBLEM_WEATHER_VANE_ARROWTOP_IRON_NORTH_SOUTH_AABB;
                    break;
                case SOUTH:
                    axisalignedbb = EMBLEM_WEATHER_VANE_ARROWTOP_IRON_NORTH_SOUTH_AABB;
                    break;
                case WEST:
                    axisalignedbb = EMBLEM_WEATHER_VANE_ARROWTOP_IRON_EAST_WEST_AABB;
                    break;
                case EAST:
                    axisalignedbb = EMBLEM_WEATHER_VANE_ARROWTOP_IRON_EAST_WEST_AABB;
            }
