...
public class BlockMetalCapSharpGold extends BlockDirectional
{
	public static DamageSource metalspikeDamage = new DamageSource("metal_spikes");
	...
	public BlockMetalCapSharpGold(String blockName)
	{
		super(Material.IRON);
    ...
    {
    	entityIn.attackEntityFrom(metalspikeDamage, 3.0F);
    }
