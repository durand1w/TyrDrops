...
public class ItemEasterEgg2 extends Item 
{
	private static double rand;
	public Random Rand = new Random();
	
	public ItemEasterEgg2(String itemName)
	{
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
    	...
    	if (playerIn.isSneaking())
    	{
    		...
    		{
    		case 0: playerIn.dropItem(new ItemStack(Items.GOLD_NUGGET), false);
    		break;
    		case 1: playerIn.dropItem(new ItemStack(TyrDropItems.barter_fairy_festival,(Rand.nextInt(2) + 1)), false);
    		break;
    		case 2: playerIn.dropItem(new ItemStack(TyrDropItems.food_licorice_red), false);
    		break;
    		case 3: playerIn.dropItem(new ItemStack(TyrDropItems.barter_fairy_festival,(Rand.nextInt(3) + 1)), false);
    		break;
    		case 4: playerIn.dropItem(new ItemStack(Items.IRON_NUGGET), false);
    		break;
