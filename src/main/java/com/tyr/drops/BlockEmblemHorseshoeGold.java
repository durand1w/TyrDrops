...
public class BlockEmblemHorseshoeGold extends Block 
{

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	protected static final AxisAlignedBB EMBLEM_HORSESHOE_GOLD_SOUTH_AABB = new AxisAlignedBB(0.125F, 0.125F, 1.0F, 0.875F, 0.875F, 0.9375F);
	protected static final AxisAlignedBB EMBLEM_HORSESHOE_GOLD_WEST_AABB = new AxisAlignedBB(0.0F, 0.125F, 0.125F, 0.0625F, 0.875F, 0.875F);
	protected static final AxisAlignedBB EMBLEM_HORSESHOE_GOLD_NORTH_AABB = new AxisAlignedBB(0.125F, 0.125F, 0.0F, 0.875F, 0.875F, 0.0625F);
	protected static final AxisAlignedBB EMBLEM_HORSESHOE_GOLD_EAST_AABB = new AxisAlignedBB(0.9375F, 0.125F, 0.125F, 1.0F, 0.875F, 0.875F);	
    public BlockEmblemHorseshoeGold(String blockName)
    {       
        super(Material.IRON);
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos)
    {
        AxisAlignedBB axisalignedbb;
            ...
            switch ((EnumFacing)state.getValue(FACING))
            {
                case NORTH:
                default:
                    axisalignedbb = EMBLEM_HORSESHOE_GOLD_NORTH_AABB;
                    break;
                case SOUTH:
                    axisalignedbb = EMBLEM_HORSESHOE_GOLD_SOUTH_AABB;
                    break;
                case WEST:
                    axisalignedbb = EMBLEM_HORSESHOE_GOLD_WEST_AABB;
                    break;
                case EAST:
                    axisalignedbb = EMBLEM_HORSESHOE_GOLD_EAST_AABB;
            }
