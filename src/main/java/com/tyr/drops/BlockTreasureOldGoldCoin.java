...
public class BlockTreasureOldGoldCoin extends Block
{
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	//EAST
	protected static final AxisAlignedBB TREASURE_SOUTH_AABB = new AxisAlignedBB(0.625F, 0.0F, 0.25F, 0.875F, 0.0625F, 0.5625F);
	//SOUTH
	protected static final AxisAlignedBB TREASURE_WEST_AABB = new AxisAlignedBB(0.4375F, 0.0F, 0.625F, 0.75F, 0.0625F, 0.875F);
	//WEST
	protected static final AxisAlignedBB TREASURE_NORTH_AABB = new AxisAlignedBB(0.125F, 0.0F, 0.4375F, 0.375F, 0.0625F, 0.75F);
	//NORTH
	protected static final AxisAlignedBB TREASURE_EAST_AABB = new AxisAlignedBB(0.25F, 0.0F, 0.125F, 0.5625F, 0.0625F, 0.375F);
	
	public BlockTreasureOldGoldCoin(String blockName)
	{
