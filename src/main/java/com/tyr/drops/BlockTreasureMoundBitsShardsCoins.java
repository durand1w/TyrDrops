...
public class BlockTreasureMoundBitsShardsCoins extends Block
{
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	//EAST
	protected static final AxisAlignedBB TREASURE_SOUTH_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.375F, 1.0F);
	//SOUTH
	protected static final AxisAlignedBB TREASURE_WEST_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.375F, 1.0F);
	//WEST
	protected static final AxisAlignedBB TREASURE_NORTH_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.375F, 1.0F);
	//NORTH
	protected static final AxisAlignedBB TREASURE_EAST_AABB = new AxisAlignedBB(0.0F, 0.0F, 0.0F, 1.0F, 0.375F, 1.0F);
	
	public BlockTreasureMoundBitsShardsCoins(String blockName)
	{
		super(Material.SAND);
